...
// Change a candidates party affiliation 
app.put('/api/candidate/:id', (req, res) => {
    // check that a party id was provided before update database
    ...
    // if party id was provided, update the database
